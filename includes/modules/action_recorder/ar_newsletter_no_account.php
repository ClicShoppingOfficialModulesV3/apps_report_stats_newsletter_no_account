<?php
  ...
  class ar_newsletter_no_account
  {
    public $code;
    public $title;
    public $description;
    ...
    public function __construct()
    {
      ...
      $this->title = CLICSHOPPING::getDef('module_action_recorder_newsletter_no_account_title');
      $this->description = CLICSHOPPING::getDef('module_action_recorder_newsletter_no_account_description');

      if ($this->check()) {
        if (defined('MODULE_ACTION_RECORDER_NEWSLETTER_NO_ACCOUNT_EMAIL_MINUTES')) {
          $this->minutes = (int)MODULE_ACTION_RECORDER_NEWSLETTER_NO_ACCOUNT_EMAIL_MINUTES;
          $this->attempts = 2; // nbr de possiblite d'envoi d'email
        }
      }
    }
    ...
    {
      return defined('MODULE_ACTION_RECORDER_NEWSLETTER_NO_ACCOUNT_EMAIL_MINUTES');
    }
    ...
    public function install()
    {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          'configuration_title' => 'What do you want for the minimum minutes per e-mail for one person for anonymous newsletter ?',
          'configuration_key' => 'MODULE_ACTION_RECORDER_NEWSLETTER_NO_ACCOUNT_EMAIL_MINUTES',
    ...
    {
      return array('MODULE_ACTION_RECORDER_NEWSLETTER_NO_ACCOUNT_EMAIL_MINUTES');
    }
  }
